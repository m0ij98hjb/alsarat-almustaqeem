...
const ADHKAR_DATA: Record<string, { text: string; count: number; source: string; virtue?: string }[]> = {
  MORNING: [
    { text: 'أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ وَالْحَمْدُ لِلَّهِ لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ', count: 1, source: 'أبو داود', virtue: 'من قالها حين يصبح أُعطي خير ذلك اليوم' },
  ...
  EVENING: [
    ...
    { text: 'اللَّهُمَّ إِنِّي أَمْسَيْتُ أُشْهِدُكَ وَأُشْهِدُ حَمَلَةَ عَرْشِكَ وَمَلَائِكَتَكَ وَجَمِيعَ خَلْقِكَ', count: 4, source: 'أبو داود', virtue: 'أعتقه الله من النار' },
  ],
  SLEEP: [
  ...
  TRAVEL: [
    { text: 'اللَّهُ أَكْبَرُ سُبْحَانَ الَّذِي سَخَّرَ لَنَا هَذَا وَمَا كُنَّا لَهُ مُقْرِنِينَ', count: 1, source: 'مسلم' },
  ],
  FOOD: [
  ...
  GENERAL: [
    ...
    { text: 'لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ', count: 10, source: 'مسلم' },
  ],
}
    ...
    <div className="min-h-screen bg-islamic-cream dark:bg-islamic-navy">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-10">
          {ADHKAR_CATEGORIES_KEYS.map(cat => (
            <button
              key={cat.key}
