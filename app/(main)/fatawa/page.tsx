...
const FATWAS = [
  ...
  { id: 5, question: 'هل يجوز للمرأة قيادة السيارة؟', answer: 'يجوز للمرأة قيادة السيارة بالشروط الشرعية العامة كالالتزام بالحجاب وعدم الخلوة المحرمة، وهذا هو قول جمهور العلماء المعاصرين.', category: 'المعاصر', scholar: 'جمهور العلماء المعاصرين', isVerified: true, views: 12300 },
...
export default function FatawawPage() {
  return (
          ...
          {FATWAS.map(f => (
            <Link key={f.id} href={`/fatawa/${f.id}`} className="card-islamic p-6 group hover:border-gold-400">
              ...
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100 dark:border-gray-800">
                ...
                <span className="text-xs text-gray-400">👁 {f.views.toLocaleString('ar-SA')}</span>
              </div>
            </Link>
          ))}
        </div>
